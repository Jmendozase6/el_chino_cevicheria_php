...
<div class="side-menu bg-white vh-100">
    ...
    <section
        ...
        <a class="text-decoration-none color-text <?= $page == "home_view.php" ? 'active-text' : ''; ?>" href="../home/home_view.php"><p>Inicio</p></a>
    </section>
    <section class="d-flex ps-8 gap-4 py-3 justify-content-start align-items-center btn-start
      <?= $page == "order_view.php" ? 'active' : ''; ?> ">
        ...
        <a class="text-decoration-none color-text <?= $page == "order_view.php" ? 'active-text' : ''; ?>" href="../orders/order_view.php"><p>Pedidos</p></a>
    ...
    <section class="d-flex ps-8 gap-4 py-3 justify-content-start align-items-center btn-start">
        ...
        <a class="text-decoration-none color-text <?= $page == "...." ? 'active-text' : ''; ?>" href="#"><p>Estadísticas</p></a>
    </section>
    <section class="d-flex ps-8 gap-4 py-3 justify-content-start align-items-center btn-start">
        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 48 48"
             class="text-lg" height="1em" width="1em"
