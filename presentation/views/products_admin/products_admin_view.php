            ...
            <div class="card-body">
              <div class="table-responsive-xl">
                <div id="example_wrapper">
                  <table class="table table-sm table-hover table-responsive" id="product-list" name="product-list">
                    ...
                    <?php foreach ($productsDTO as $product) { ?>
                      <tr>
                        ...
                        <!--        <td class="align-middle">--><?php //= $product->getCreatedAt() ?><!--</td>-->
                        ...
                        <td class="align-middle">
                          ...
                          <a href="../products_admin/delete_product.php?id=<?= $product->getId() ?>"
                             class="col me-2 btn btn-outline-secondary"><i class="bi bi-trash3 text-danger"></i>
                          </a>
                        </td>
                      </tr>
                    <?php } ?>
