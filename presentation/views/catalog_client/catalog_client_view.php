        ...
        <div class="col">
                ...
                <div class="row">
                    ...
                    <div class="col pt-2">
                        <?php foreach ($categoriesDTO as $categoryDTO) { ?>
                            <a type="button" class="btn btn-outline-success py-2 px-4 category-link" data-target="<?= $categoryDTO->getId() ?>"> <?= $categoryDTO->getName() ?></a>
                        <?php } ?>
                    </div>
                </div>
            </header>
            ...
            <div class="container my-2">
                <?php for ($i = 0; $i < sizeof($categoriesDTO); $i++) { ?>
                    ...
                    <div class="row row-cols-1 row-cols-md-3g-4 mb-3">
