...
define("MERCADO_PAGO_PROD_PUBLIC_KEY", $_ENV['MERCADO_PAGO_PROD_PUBLIC_KEY']);
define("MERCADO_PAGO_PROD_ACCESS_TOKEN", $_ENV['MERCADO_PAGO_PROD_ACCESS_TOKEN']);
define("MERCADO_PAGO_PROD_CLIENT_ID", $_ENV['MERCADO_PAGO_PROD_CLIENT_ID']);
define("MERCADO_PAGO_CLIENT_SECRET", $_ENV['MERCADO_PAGO_CLIENT_SECRET']);
